...
docker run -d --name memos --restart=always --network host -v ~/docker-memos/data:/var/opt/memos -e MEMOS_DRIVER="mysql" -e MEMOS_DSN='memos_user:密码@tcp(127.0.0.1:3306)/memos?charset=utf8mb4&parseTime=True&loc=Local' ghcr.io/usememos/memos:0.26.2
```
...
```bash
docker rename memos memos-canary-0305
```
